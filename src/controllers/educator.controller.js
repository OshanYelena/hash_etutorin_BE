...
exports.updateEducatorBasicDetails = async (req, res) => {
    ...
    try {
        const { user_id, country, grades, subject_ids, description, profile_image_ref } = req.body;
        ...
        const temp_educator = {
            ...
            profile_image_ref: profile_image_ref?profile_image_ref:educator.profile_image_ref ,
        }
...
exports.updateEducatorBankDetails = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).send({ message: "Educator bank details updated successfully!" });
